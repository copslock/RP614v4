...
* All rights reserved.
* 
* $Header: /home/cvsroot/uClinux-dist/user/boa/src/rtl865x/flashdrv.c,v 1.8 2005/12/02 11:00:36 yjlou Exp $
*
...
retry:
		...
		if ( Read != 0xffff )
		{
//ch##			rtlglue_printf( "Warning! Write flash failed: content of address(0x%08x) is NOT 0xffff (0x%04x), go ahead.\n", (uint32)dstAddr, Read );
		}
