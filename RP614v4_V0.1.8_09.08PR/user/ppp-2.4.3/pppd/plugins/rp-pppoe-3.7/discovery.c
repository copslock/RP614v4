...
"$Id: discovery.c,v 1.2 2005/12/02 09:11:18 tony Exp $";
...
#if 1 // tony: support for romeDriver
int shmid=0;
romeCfgParam_t * pRomeCfgParam;	
extern unsigned int rtl865x_dsid;
#endif    
...
#if 1
    memcpy(pRomeCfgParam->pppoeCfgParam[rtl865x_dsid].svrMac,conn->peerEth,6);
#endif    
...
#if 1 // tony: let romeDriver understand the pppoe session ID.
	pRomeCfgParam->pppoeCfgParam[rtl865x_dsid].sessionId=conn->session;
#endif    
