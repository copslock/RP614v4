...
//#define	CACHE_TIME		(    10 * CACHE_TIMEUNIT)
//#define CACHE_MAXTIME		(    60 * CACHE_TIMEUNIT)
...
//#define	CACHE_MINCYCLE		(1 * CACHE_TIMEUNIT)
...
#define	CACHE_HIGHWATER		 100
#define	CACHE_LOWWATER		  80
...
//#ifdef DNS_HIJACK    
#if 0
    if (cache_total > cache_highwater) {
	expire_oldest(cache_total);    
    }	
#endif    
