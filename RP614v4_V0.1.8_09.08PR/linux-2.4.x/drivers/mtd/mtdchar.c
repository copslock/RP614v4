/*
 * $Id: mtdchar.c,v 1.3 2005/11/30 07:47:51 alva_zhang Exp $
 *
		     ...
		     u_int cmd, u_long arg)
{
	...
	case MEMINFOINIT:
	{
          struct mtd_flashdev *my_mtd_dev=(struct mtd_flashdev *)arg;   
		  
          my_mtd_dev->erasize=mtd->erasesize; 
          my_mtd_dev->buswidth = map->buswidth;
          my_mtd_dev->chipsize =  map->size;
          break;
	}
	default:
