# 1 "rtl8651_dns_domainBlock.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "rtl8651_dns_domainBlock.c"
# 13 "rtl8651_dns_domainBlock.c"
# 1 "rtl_types.h" 1
# 204 "rtl_types.h"
...
# 14 "rtl8651_dns_domainBlock.c" 2
# 1 "assert.h" 1
# 15 "rtl8651_dns_domainBlock.c" 2
# 1 "types.h" 1
# 16 "rtl8651_dns_domainBlock.c" 2
# 1 "rtl_errno.h" 1
# 17 "rtl8651_dns_domainBlock.c" 2
# 1 "rtl_glue.h" 1
# 110 "rtl_glue.h"
# 1 "mbuf.h" 1
# 30 "mbuf.h"
...
# 18 "rtl8651_dns_domainBlock.c" 2
...
# 22 "rtl8651_dns_domainBlock.c" 2
...
# 23 "rtl8651_dns_domainBlock.c" 2
...
# 24 "rtl8651_dns_domainBlock.c" 2
...
# 25 "rtl8651_dns_domainBlock.c" 2

static _rtl8651_domainBlockingBlockList_t *_rtl8651_domainBlocking_findBlockList(_rtl8651_domainBlockingInfo_t *info, ipaddr_t mapped_ip);
static int32 _rtl8651_domainBlocking_delBlockInfo(_rtl8651_domainBlockingInfo_t *info, uint8 fromDbModule);
static int32 _rtl8651_domainBlocking_delBlockList(_rtl8651_domainBlockingBlockList_t *ptr, uint8 refreshACL);
# 44 "rtl8651_dns_domainBlock.c"
static uint8 _rtl8651_domainBlocking_procSequence = 0;
static uint32 _rtl8651_domainBlocking_blockListTimeout = 0;
static _rtl8651_domainBlockingInfo_t *_rtl8651_domainBlocking_info_inused = ((void *)0);
static _rtl8651_domainBlockingInfo_t *_rtl8651_domainBlocking_info_freeList = ((void *)0);
static _rtl8651_domainBlockingBlockList_t *_rtl8651_domainBlocking_blockList_h = ((void *)0);
static _rtl8651_domainBlockingBlockList_t *_rtl8651_domainBlocking_blockList_t = ((void *)0);
static _rtl8651_domainBlockingBlockList_t *_rtl8651_domainBlocking_blockList_freeList = ((void *)0);
...
int32 _rtl8651_registerDomainBlock(void)
{
        return _rtl8651_dns_registerProcess( &_rtl8651_domainBlocking_procSequence,
                                                                                (0<<0),
                                                                                _rtl8651_domainBlocking_init,
                                                                                _rtl8651_domainBlocking_flushBlockList,
                                                                                _rtl8651_domainBlocking_procMapping,
                                                                                _rtl8651_domainBlocking_timeUpdate,
                                                                                _rtl8651_domainBlocking_blockInfoDestructor);
}
# 81 "rtl8651_dns_domainBlock.c"
int32 _rtl8651_domainBlocking_init(void *_para)
{
        rtl8651_fwdEngineInitPara_t *para = (rtl8651_fwdEngineInitPara_t *)_para;

        _rtl8651_domainBlocking_info_inused = ((void *)0);
        _rtl8651_domainBlocking_info_freeList = ((void *)0);
        _rtl8651_domainBlocking_blockList_h = ((void *)0);
        _rtl8651_domainBlocking_blockList_t = ((void *)0);
        _rtl8651_domainBlocking_blockList_freeList = ((void *)0);
        _rtl8651_domainBlocking_blockListTimeout = 0;

        if ( (para->domainBlock_tblSize == 0) ||
                (para->domainBlock_maxBlockEntryCnt == 0) ||
                (para->domainBlock_blockEntryTimeout == 0))
        {
                ;
        ...
        do { (_rtl8651_domainBlocking_info_freeList) = rtlglue_malloc((sizeof(_rtl8651_domainBlockingInfo_t) * para->domainBlock_tblSize)); if ((_rtl8651_domainBlocking_info_freeList) == ((void *)0)) { do {printk("[%s-%d]-error-: " "malloc memory (size: %d) FAILED, return %d.\n" "\n", __FUNCTION__, 103, (sizeof(_rtl8651_domainBlockingInfo_t) * para->domainBlock_tblSize), (-1));} while (0);; return (-1); } memset((_rtl8651_domainBlocking_info_freeList), 0, (sizeof(_rtl8651_domainBlockingInfo_t) * para->domainBlock_tblSize)); } while (0);;
        do { _rtl8651_domainBlockingInfo_t *__tmp; int __idx; __tmp = (_rtl8651_domainBlockingInfo_t *)(_rtl8651_domainBlocking_info_freeList); for (__idx = 0 ; __idx < ((para->domainBlock_tblSize) - 1) ; __idx ++, __tmp ++) { (__tmp)->next = __tmp + 1; } (__tmp)->next = ((void *)0); } while (0);;

        do { (_rtl8651_domainBlocking_blockList_freeList) = rtlglue_malloc((sizeof(_rtl8651_domainBlockingBlockList_t) * para->domainBlock_maxBlockEntryCnt)); if ((_rtl8651_domainBlocking_blockList_freeList) == ((void *)0)) { do {printk("[%s-%d]-error-: " "malloc memory (size: %d) FAILED, return %d.\n" "\n", __FUNCTION__, 106, (sizeof(_rtl8651_domainBlockingBlockList_t) * para->domainBlock_maxBlockEntryCnt), (-1));} while (0);; return (-1); } memset((_rtl8651_domainBlocking_blockList_freeList), 0, (sizeof(_rtl8651_domainBlockingBlockList_t) * para->domainBlock_maxBlockEntryCnt)); } while (0);;
        do { _rtl8651_domainBlockingBlockList_t *__tmp; int __idx; __tmp = (_rtl8651_domainBlockingBlockList_t *)(_rtl8651_domainBlocking_blockList_freeList); for (__idx = 0 ; __idx < ((para->domainBlock_maxBlockEntryCnt) - 1) ; __idx ++, __tmp ++) { (__tmp)->next = __tmp + 1; } (__tmp)->next = ((void *)0); } while (0);;

        _rtl8651_domainBlocking_blockListTimeout = para->domainBlock_blockEntryTimeout;
...
void _rtl8651_domainBlocking_flushBlockList(void)
{
        ...
        while (_rtl8651_domainBlocking_blockList_h)
        {
                refreshAcl = 1;
                _rtl8651_domainBlocking_delBlockList(_rtl8651_domainBlocking_blockList_h, 0);
        }
...
int32 _rtl8651_domainBlocking_procMapping(
        char *orig_domain,
        char *mapped_domain,
        ipaddr_t mapped_ip,
        void *_info)
{
        _rtl8651_domainBlockingInfo_t *info = (_rtl8651_domainBlockingInfo_t *)_info;
        _rtl8651_domainBlockingBlockList_t *blkList;


        if ((blkList = _rtl8651_domainBlocking_findBlockList(info, mapped_ip)) != ((void *)0))
        {

                blkList->updateTime = _sysUpSeconds;
                do { do { if (blkList->next) { blkList->next->prev = blkList->prev; } if (blkList->prev) { blkList->prev->next = blkList->next; } if (_rtl8651_domainBlocking_blockList_h == blkList) { _rtl8651_domainBlocking_blockList_h = blkList->next; } if (_rtl8651_domainBlocking_blockList_t == blkList) { _rtl8651_domainBlocking_blockList_t = blkList->prev; } blkList->next = blkList->prev = ((void *)0); } while (0);; do { if (_rtl8651_domainBlocking_blockList_t) { _rtl8651_domainBlocking_blockList_t->next = blkList; } else { _rtl8651_domainBlocking_blockList_h = blkList; } blkList->prev = _rtl8651_domainBlocking_blockList_t; blkList->next = ((void *)0); _rtl8651_domainBlocking_blockList_t = blkList; } while (0);; } while (0);;
        } else
        {

                if (_rtl8651_domainBlocking_blockList_freeList == ((void *)0))
                {
                        if (_rtl8651_domainBlocking_blockList_h)
                        {
                                _rtl8651_domainBlocking_delBlockList(_rtl8651_domainBlocking_blockList_h, 0);
                        }
                }

                if ((blkList = _rtl8651_domainBlocking_blockList_freeList) != ((void *)0))
                {
                        _rtl8651_domainBlocking_blockList_freeList = blkList->next;
                        ...
                        blkList->info = info;
                        blkList->updateTime = _sysUpSeconds;
                        blkList->dip = mapped_ip;

                        do { if (_rtl8651_domainBlocking_blockList_t) { _rtl8651_domainBlocking_blockList_t->next = blkList; } else { _rtl8651_domainBlocking_blockList_h = blkList; } blkList->prev = _rtl8651_domainBlocking_blockList_t; blkList->next = ((void *)0); _rtl8651_domainBlocking_blockList_t = blkList; } while (0);;
                }
        }
...
void _rtl8651_domainBlocking_timeUpdate(uint32 secPassed)
{
        ...
        while ( _rtl8651_domainBlocking_blockList_h &&
                        ((_rtl8651_domainBlocking_blockList_h->updateTime + _rtl8651_domainBlocking_blockListTimeout) < _sysUpSeconds))
        {
                refreshAcl = 1;
                _rtl8651_domainBlocking_delBlockList(_rtl8651_domainBlocking_blockList_h, 0);
        }
...
int32 _rtl8651_domainBlocking_blockInfoDestructor(void *info)
{
        return _rtl8651_domainBlocking_delBlockInfo((_rtl8651_domainBlockingInfo_t *)info, 0);
}
# 229 "rtl8651_dns_domainBlock.c"
int32 rtl8651_domainBlocking_addDomainBlockingEntry(char *domain_name, rtl8651_domainBlockingInfo_t *usrInfo)
{
        int32 retval;
        ...
        retval = _rtl8651_domainBlocking_addDomainBlockingEntry(domain_name, usrInfo);
...
int32 _rtl8651_domainBlocking_addDomainBlockingEntry(char *domain_name, rtl8651_domainBlockingInfo_t *usrInfo)
{
        void *tmp = ((void *)0);
        char *domain;
        rtl8651_domainBlockingInfo_t dummy, *usedUsrInfo = usrInfo;
        _rtl8651_domainBlockingInfo_t *info;

        if (domain_name == ((void *)0))
        {
                return -1;
        }
        ...
        while (_rtl8651_dns_findProcessEntry( _rtl8651_domainBlocking_procSequence,
                                                                                        domain_name,
                                                                                        ((void *)0),
                                                                                        (char**)&domain,
                                                                                        (void*)&info,
                                                                                        (void*)&tmp) == 1)
        {
                ...
                if ( (strcmp(domain, domain_name) == 0) &&
                        (memcmp(&(info->info), usedUsrInfo, sizeof(rtl8651_domainBlockingInfo_t)) == 0))
                {
                        return 0;
                }
        }
        ...
        if (_rtl8651_domainBlocking_info_freeList)
        {
                info = _rtl8651_domainBlocking_info_freeList;
                if (_rtl8651_dns_addProcessEntry( _rtl8651_domainBlocking_procSequence,
                                                                                        domain_name,
                                                                                        (void*)info,
                                                                                        &(info->ctrlEntry)) == 0)
                {
                        do { if (info->next) { info->next->prev = info->prev; } if (info->prev) { info->prev->next = info->next; } if (_rtl8651_domainBlocking_info_freeList == info) { _rtl8651_domainBlocking_info_freeList = info->next; } info->next = info->prev = ((void *)0); } while (0);;
                        do { if (_rtl8651_domainBlocking_info_inused) { _rtl8651_domainBlocking_info_inused->prev = info; } info->next = _rtl8651_domainBlocking_info_inused; info->prev = ((void *)0); _rtl8651_domainBlocking_info_inused = info; } while (0);;
                        rtl8651_memcpy(&(info->info), usedUsrInfo, sizeof(rtl8651_domainBlockingInfo_t));
                        return 0;
                }
        }
...
int32 rtl8651_domainBlocking_delDomainBlockingEntry(char *domain_name, rtl8651_domainBlockingInfo_t *usrInfo)
{
        ...
        rtlglue_drvMutexLock();
        retval = _rtl8651_domainBlocking_delDomainBlockingEntry(domain_name, usrInfo);
        rtlglue_drvMutexUnlock();
...
int32 _rtl8651_domainBlocking_delDomainBlockingEntry(char *domain_name, rtl8651_domainBlockingInfo_t *usrInfo)
{
                                                                                        ...
                                                                                        (void*)&tmp) == 1)
        {
                ...
                if ( (strcmp(domain, domain_name) == 0) &&
                        (memcmp(&(info->info), usedUsrInfo, sizeof(rtl8651_domainBlockingInfo_t)) == 0))
                {
                        if (_rtl8651_domainBlocking_delBlockInfo(info, 1) != 0)
                        {
                                return -1;
                        }
...
# 369 "rtl8651_dns_domainBlock.c"
int32 rtl8651_domainBlocking_flushDomainBlockingEntry(void)
{
        int32 ret;

        rtlglue_drvMutexLock();
        ret = _rtl8651_domainBlocking_flushDomainBlockingEntry();
        rtlglue_drvMutexUnlock();
...
int32 _rtl8651_domainBlocking_flushDomainBlockingEntry(void)
{
        while( _rtl8651_domainBlocking_info_inused )
        {
                if (_rtl8651_domainBlocking_delBlockInfo(_rtl8651_domainBlocking_info_inused, 1) != 0)
                {
                        return -1;
                }
        }
...
void rtl8651_domainBlocking_dump(void)
{
        ...
        info = _rtl8651_domainBlocking_info_inused;
        while (info)
        {
                inusedCnt ++;
                info = info->next;
        ...
        if (inusedCnt)
        {
                ...
                while (info)
                {
                        domain = _rtl8651_dns_getProcessEntryDomainInfo(info->ctrlEntry);
                        printk("\t%2d    %03u.%03u.%03u.%03u/%03u.%03u.%03u.%03u\t\t%p\n\t\t\t=> (%s)\n",
                                idx,
                                ((unsigned char *)&info->info.sip)[0], ((unsigned char *)&info->info.sip)[1], ((unsigned char *)&info->info.sip)[2], ((unsigned char *)&info->info.sip)[3],
                                ((unsigned char *)&info->info.sipMask)[0], ((unsigned char *)&info->info.sipMask)[1], ((unsigned char *)&info->info.sipMask)[2], ((unsigned char *)&info->info.sipMask)[3],
                                info,
                                domain?domain:"(NULL)");
                        idx ++;
                        info = info->next;
        ...
        blkList = _rtl8651_domainBlocking_blockList_h;
        while (blkList)
        {
                inusedCnt ++;
                blkList = blkList->next;
        }
        blkList = _rtl8651_domainBlocking_blockList_freeList;
        while (blkList)
        {
                freeCnt ++;
                blkList = blkList->next;
        ...
        if (inusedCnt)
        {
                ...
                while (blkList)
                {
                        info = blkList->info;
                        domain = _rtl8651_dns_getProcessEntryDomainInfo(info->ctrlEntry);
                        printk("\t%5d  %03u.%03u.%03u.%03u/%03u.%03u.%03u.%03u\t(%03u.%03u.%03u.%03u)\n\t\t\t=> (%s)\n",
                                blkList->updateTime + _rtl8651_domainBlocking_blockListTimeout - _sysUpSeconds,
                                ((unsigned char *)&info->info.sip)[0], ((unsigned char *)&info->info.sip)[1], ((unsigned char *)&info->info.sip)[2], ((unsigned char *)&info->info.sip)[3],
                                ((unsigned char *)&info->info.sipMask)[0], ((unsigned char *)&info->info.sipMask)[1], ((unsigned char *)&info->info.sipMask)[2], ((unsigned char *)&info->info.sipMask)[3],
                                ((unsigned char *)&blkList->dip)[0], ((unsigned char *)&blkList->dip)[1], ((unsigned char *)&blkList->dip)[2], ((unsigned char *)&blkList->dip)[3],
                                domain?domain:"(NULL)");
                        blkList = blkList->next;
                }
                printk("\t============================================================\n");
...
uint32 _rtl8651_tryToAddAclRuleForDnsDomainBlocking(rtl8651_tblDrv_vlanTable_t *vlanPtr, uint32 aclStart, uint32 aclEnd, int8 *enoughFlag)
{
        ...
        if ( vlanPtr->internal )
        {
                _rtl8651_domainBlockingBlockList_t *blkList = _rtl8651_domainBlocking_blockList_h;
                ...
                while ( blkList )
                {
                        ...
                        rule.un_ty.L3L4._srcIpAddr = blkList->info->info.sip;
                        rule.un_ty.L3L4._srcIpAddrMask = blkList->info->info.sipMask;
                        rule.un_ty.L3L4._dstIpAddr = blkList->dip;
...
# 551 "rtl8651_dns_domainBlock.c"
static _rtl8651_domainBlockingBlockList_t *_rtl8651_domainBlocking_findBlockList(_rtl8651_domainBlockingInfo_t *info, ipaddr_t mapped_ip)
{
        _rtl8651_domainBlockingBlockList_t *ptr;

        ptr = _rtl8651_domainBlocking_blockList_h;

        while (ptr)
        {
                if ((ptr->info == info) && (ptr->dip == mapped_ip))
                {
                        return ptr;
                }
                ptr = ptr->next;
...
static int32 _rtl8651_domainBlocking_delBlockInfo(_rtl8651_domainBlockingInfo_t *info, uint8 fromDbModule)
{
        _rtl8651_domainBlockingBlockList_t * ptr, *prev;
        uint8 refreshAcl = 0;

        if (fromDbModule == 1)
        {
# 587 "rtl8651_dns_domainBlock.c"
                if (_rtl8651_dns_delProcessEntry( _rtl8651_domainBlocking_procSequence,
                                                                                1,
                                                                                info->ctrlEntry,
                                                                                ((void *)0),
                                                                                ((void *)0)) != 0)
        ...
        } else
        {
                ...
                do { if (info->next) { info->next->prev = info->prev; } if (info->prev) { info->prev->next = info->next; } if (_rtl8651_domainBlocking_info_inused == info) { _rtl8651_domainBlocking_info_inused = info->next; } info->next = info->prev = ((void *)0); } while (0);;
                do { if (_rtl8651_domainBlocking_info_freeList) { _rtl8651_domainBlocking_info_freeList->prev = info; } info->next = _rtl8651_domainBlocking_info_freeList; info->prev = ((void *)0); _rtl8651_domainBlocking_info_freeList = info; } while (0);;
        }
        ...
        while (ptr)
        {
                if (ptr->info == info)
                {
                        _rtl8651_domainBlocking_delBlockList(ptr, 0);
                        refreshAcl = 1;
                        ptr = prev;
                } else
                {
...
static int32 _rtl8651_domainBlocking_delBlockList(_rtl8651_domainBlockingBlockList_t *ptr, uint8 refreshACL)
{
        ...
        do { if (ptr->next) { ptr->next->prev = ptr->prev; } if (ptr->prev) { ptr->prev->next = ptr->next; } if (_rtl8651_domainBlocking_blockList_h == ptr) { _rtl8651_domainBlocking_blockList_h = ptr->next; } if (_rtl8651_domainBlocking_blockList_t == ptr) { _rtl8651_domainBlocking_blockList_t = ptr->prev; } ptr->next = ptr->prev = ((void *)0); } while (0);;
        do { if (_rtl8651_domainBlocking_blockList_freeList) { _rtl8651_domainBlocking_blockList_freeList->prev = ptr; } ptr->next = _rtl8651_domainBlocking_blockList_freeList; ptr->prev = ((void *)0); _rtl8651_domainBlocking_blockList_freeList = ptr; } while (0);;
        if (refreshACL == 1)
        {
                _rtl8651_arrangeAllACL();
        }
