...
* $Id: rtl8651_tblDrv.h,v 1.107 2005/12/02 13:27:22 chenyl Exp $
*
*/
...
typedef struct ___rtl8651_tblDrvPolicyRoute_t
{
	...
	union
	{
		...
		struct {
			ipaddr_t sip;
			ipaddr_t dip;
		} sipDipPair;			/* Internal used Only! for a specific source/destination IP pair */
...
#define RTL8651_ACL_IP_RANGE			0xa
#define RTL8651_ACL_ICMP_IPRANGE		0xb
#define RTL8651_ACL_TCP_IPRANGE		0xc
#define RTL8651_ACL_IGMP_IPRANGE		0xd
#define RTL8651_ACL_UDP_IPRANGE		0xe
...
/* For Policy Route*/
#define TYPE_BITS				0x0f
#define DYNAMIC_POLICY_ROUTE	0x02
#define STATIC_POLICY_ROUTE	0x04
...
#define TRIGGER_SIPDIPPAIR		0x60		/* Internal used Only */
