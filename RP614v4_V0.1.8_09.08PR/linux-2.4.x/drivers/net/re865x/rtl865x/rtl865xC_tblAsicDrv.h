...
int32 rtl865xc_setAsicVlan(rtl865x_tblAsicDrv_vlanParam_t *vlanp) ;
int32 rtl8651_delAsicVlan(uint16 vid);
int32 rtl8651_getAsicVlan(uint16 vid, rtl865x_tblAsicDrv_vlanParam_t *vlanp);
int32 rtl865xc_getAsicVlan(uint16 vid, rtl865x_tblAsicDrv_vlanParam_t *vlanp);
int32 rtl865xc_getAsicNetInterface(uint16 vid, rtl865x_tblAsicDrv_vlanParam_t *vlanp);
