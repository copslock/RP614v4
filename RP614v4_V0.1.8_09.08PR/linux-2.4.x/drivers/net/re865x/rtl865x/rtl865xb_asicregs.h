...
* All rights reserved.
* 
* $Header: /home/cvsroot/uClinux-dist/linux-2.4.x/drivers/net/re865x/rtl865x/rtl865xb_asicregs.h,v 1.4 2005/10/20 06:31:21 shliu Exp $
*
* Abstract: ASIC specific definitions.
*
* $Author: shliu $
*
* $Log: rtl865xb_asicregs.h,v $
* Revision 1.4  2005/10/20 06:31:21  shliu
* *: add a definition for EN_RATELIMIT_HWAGING
*
* Revision 1.3  2005/10/13 08:30:33  yjlou
* *: porting icExport function to 865xB platform to dump swcore registers and table content, said modelExportSwcoreRegistersAndTables().
*
* Revision 1.2  2005/09/23 03:19:50  yjlou
...
*
* Revision 1.1  2005/09/14 08:26:23  rupert
* *: rename filename
*
* Revision 1.1  2005/09/14 06:47:32  rupert
* +: Add 865xC register Definition and Asic Driver
*
* Revision 1.27  2005/09/12 06:40:19  tony
* +: add RTL865XC NIC driver initial version.
*
* Revision 1.26  2005/09/09 15:04:14  yjlou
...
*    blah blah
*
* Revision 1.25  2005/08/02 06:04:14  yjlou
* +: add GDMA model code: only base64 and qouted-printable encode/decode.
*
* Revision 1.24  2005/07/27 10:15:32  shliu
* *: add RTL865xB d-cut software vlan support
*
* Revision 1.23  2005/07/20 15:29:37  yjlou
* +: porting Model Code to Linux Kernel: check RTL865X_MODEL_KERNEL.
*
* Revision 1.22  2005/07/19 13:47:59  brian_bin
* *:brian_bin add some PCM constants
*
* Revision 1.21  2005/07/11 12:43:15  shliu
* *: add a definition for MII enforce mode.
*
* Revision 1.20  2005/06/19 05:41:19  yjlou
* *: merge ASIC driver into model code.
*
* Revision 1.19  2005/05/23 12:47:00  yjlou
* +: add PCM registers definition.
*
* Revision 1.18  2005/05/20 13:51:28  shliu
* *: Add PSIR0 & PSIR1 definition.
*
...
#else
/* Target Platform (including RTL865X_MODEL_KERNEL), and RTL865X_TEST */
...
#define REAL_SWCORE_BASE		0xBC800000
#define REAL_BD01_BASE			0xBD010000
#define REAL_SYSTEM_BASE		REAL_BD01_BASE
#define REAL_HSB_BASE			0xBC0F0000
#define REAL_HSA_BASE			0xBC0F0040
#define REAL_SWTBL_BASE			0xBC000000

#if defined(RTL865X_TEST) || defined(RTL865X_MODEL_USER) || defined(RTL865X_MODEL_KERNEL)
#define VIRTUAL_SWCORE_REG_SIZE	(1*64*1024) /* said, BC80_xxxx */
#define VIRTUAL_SYSTEM_REG_SIZE	(1*64*1024) /* said, BD01_xxxx */
#define VIRTUAL_SWCORE_TBL_SIZE	(1*1024*1024)
...
#define BD01_BASE			((uint32)pVirtualSysReg)
#define BD01_SIZE			(VIRTUAL_SYSTEM_REG_SIZE)
...
#define BD01_BASE			REAL_BD01_BASE
#endif
...
#define EN_RATELIMIT_HWAGING               (1 << 30)   /* Enable rate limit table hardware aging (token refill) capability */
...
#define CRYPTO_BASE			 (BD01_BASE+0x9000)	/* 0xBD019000 */
...
#define IPS_SDUE		(1<<15)				/* Source Descriptor Unavailable Error Interrupt */
#define IPS_SDLE		(1<<14)				/* Source Descriptor Length Error Interrupt */
#define IPS_DDUE		(1<<13)				/* Destination Descriptor Unavailable Error Interrupt */
#define IPS_DDOK		(1<<12)				/* Destination Descriptor OK Interrupt */
...
#define IPS_SDUEM		(1<<15)				/* Source Descriptor Unavailable Error Interrupt Mask */
#define IPS_SDLEM		(1<<14)				/* Source Descriptor Length Error Interrupt Mask */
#define IPS_DDUEM		(1<<13)				/* Destination Descriptor Unavailable Error Interrupt Mask */
#define IPS_DDOKM		(1<<12)				/* Destination Descriptor OK Interrupt Mask */
...
/* PCM */
#define PCM_BASE		(BD01_BASE+0x7000)	/* 0xBD017000 */
...
#define GDMA_DBUDRIE		(1<<29)		/* destination Block EUnder-run Interrupt Enable */
...
#define GDMA_DBUDRIP		(1<<29)		/* destination Block EUnder-run Interrupt Status (write 1 to clear) */
