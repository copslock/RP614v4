# 1 "rtl8651_tblBasicDrv.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "rtl8651_tblBasicDrv.c"
# 57 "rtl8651_tblBasicDrv.c"
# 1 "rtl_types.h" 1
# 204 "rtl_types.h"
...
# 58 "rtl8651_tblBasicDrv.c" 2
# 1 "types.h" 1
# 59 "rtl8651_tblBasicDrv.c" 2

# 1 "asicRegs.h" 1
# 39 "asicRegs.h"
# 1 "rtl865xb_asicregs.h" 1
# 40 "asicRegs.h" 2
# 61 "rtl8651_tblBasicDrv.c" 2
# 1 "asicTabs.h" 1
# 62 "rtl8651_tblBasicDrv.c" 2
...
# 63 "rtl8651_tblBasicDrv.c" 2
# 72 "rtl8651_tblBasicDrv.c"
...
static void _rtl8651_asicTableAccessForward(uint32 tableType, uint32 eidx, void *entryContent_P) {
        if (!(entryContent_P)) {printk("\nAssert Fail: %s %d", "rtl8651_tblBasicDrv.c", 93); while(1);};
...

        {
                ...
                {
                        (*((volatile uint32 *)((0x020 + (0xBC800000 + 0x00000000))+(index<<2))))=(*((uint32 *)entryContent_P + index));
                }
        }
# 118 "rtl8651_tblBasicDrv.c"
        (*((volatile uint32 *)((0x008 + (0xBC800000 + 0x00000000)))))=((uint32) (0xBC000000 + ((tableType)<<16) ) + eidx * (8 * sizeof(uint32)));
}

int32 _rtl8651_addAsicEntry(uint32 tableType, uint32 eidx, void *entryContent_P) {
        _rtl8651_asicTableAccessForward(tableType, eidx, entryContent_P);

        (*((volatile uint32 *)((0x000 + (0xBC800000 + 0x00000000)))))=(1 | (1 << 1));

        while ( (((*((volatile uint32 *)((0x000 + (0xBC800000 + 0x00000000)))))) & 1) != 0 );

        if ( (((*((volatile uint32 *)((0x004 + (0xBC800000 + 0x00000000)))))) & 1) != 0 )
                return -1;
        return 0;
}
...
int32 _rtl8651_readAsicEntry(uint32 tableType, uint32 eidx, void *entryContent_P) {
        ...
        if (!(entryContent_P)) {printk("\nAssert Fail: %s %d", "rtl8651_tblBasicDrv.c", 146); while(1);};
        entryAddr = (uint32 *) (
                (uint32) (0xBC000000 + ((tableType)<<16) ) + (eidx<<5 ) ) ;
...

        {
                ...
                for( index = 0; index < _rtl8651_asicTableSize[tableType]; index++ )
                {
                        *((uint32 *)entryContent_P + index) = *(entryAddr + index);
                }
        }
# 174 "rtl8651_tblBasicDrv.c"
        tmp = *(uint32 *)((uint32) (0xBC000000 + ((TYPE_ACL_RULE_TABLE)<<16) ) + 1024 * (8 * sizeof(uint32)));
...
int32 _rtl8651_delAsicEntry(uint32 tableType, uint32 startEidx, uint32 endEidx) {
  uint32 eidx = startEidx;
...

        {
                ...
                for( index = 0; index < _rtl8651_asicTableSize[tableType]; index++ )
                {
                        (*((volatile uint32 *)((0x020 + (0xBC800000 + 0x00000000))+(index<<2))))=(0);
                }
        }
# 204 "rtl8651_tblBasicDrv.c"
        while (eidx <= endEidx) {
                (*((volatile uint32 *)((0x008 + (0xBC800000 + 0x00000000)))))=((uint32) (0xBC000000 + ((tableType)<<16) ) + eidx * (8 * sizeof(uint32)));
