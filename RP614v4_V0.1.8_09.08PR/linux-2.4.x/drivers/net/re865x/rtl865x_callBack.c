...
extern uint32 vlan_lan_ip; //Add by Timo
	...
	const char *pathFiltered)
{
	...
	first = (vlan_lan_ip&0xFF000000)>>24;
	second = (vlan_lan_ip&0x00FF0000)>>16;
	third = (vlan_lan_ip&0x0000FF00)>>8;
	fourth = vlan_lan_ip&0x000000FF;
	
	sprintf(net_string, "%u.%u.%u.%u", first, second, third, fourth);
	sprintf( retmsg,
   	"HTTP/1.1 302 FOUND\r\nLocation: http://%s/blockurl.html\r\nTransfer-Encoding: chunked\r\nContent-Type: text/html\r\n\r\n0\r\n\r\n", net_string);
