...
static char *log_desc[RTL8651_TOTAL_USERLOG_NO] =
{
	...
	"[Hybrid Scan]",
   								...
   								/* RTL8651_LOG_DOS_TcpUdpScan_HYBRID */
};
...
#define RTL8651_LOG_STRING_ITEM_STRING	"%s %s%s" //Timo
...
#define RTL8651_LOG_TIME_STRING	"%s,%02d %s %04d %02d:%02d:%02d"
//#define RTL8651_LOG_TIME_VARLIST	tm.tm_year,tm.tm_mon+1,tm.tm_mday,tm.tm_hour,tm.tm_min,tm.tm_sec
//#define RTL8651_LOG_TIME_VARLIST	tm.tm_wday,tm.tm_mday,tm.tm_mon+1,tm.tm_year,tm.tm_hour,tm.tm_min,tm.tm_sec
/******************************
 log detail format definition
******************************/
/* <--- pkt ---> */

/**** DNI DEFINED TYPE HERE***/
//Add by Timo Wu
#define DNI_LOG_INFO_PKT_DENIED	"[Deny access policy matched, dropping packet] "
/***END***/
...
#define RTL8651_LOG_INFO_URL_TCPSTRING	"[%s:%s/%s Match Keyword:%s %s] Source: %u.%u.%u.%u " //Timo
/* comment by Timo
...
#define RTL8651_LOG_INFO_URL_UDPSTRING	"[%s:%s/%s Match Keyword:%s %s] Source: %u.%u.%u.%u " //Timo
/* comment by Timo
...
#define RTL8651_LOG_INFO_URL_OTHERSTRING	"[%s:%s/%s Match Keyword:%s %s] Source: %u.%u.%u.%u " //Timo
/* comment by Timo
