...
extern void usb_hcd_giveback_urb_rtl8652 (struct usb_hcd *hcd, struct urb *urb,
		struct pt_regs *regs);

#ifdef CONFIG_PCI

//struct pci_device_id;
//extern int usb_hcd_pci_probe (struct pci_dev *dev, 	const struct pci_device_id *id);
extern int usb_hcd_probe_rtl8652 (struct hc_driver *);
...
#include "hub.h" //rtl8652 share with standard EHCI driver
