 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.9 2005/12/07 11:31:43 rupert Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.9 2005/12/07 11:31:43 rupert Exp $";
...
#if defined(CONFIG_RTL865X_IPSEC)&&defined(CONFIG_RTL865X_MULTILAYER_BSP)
			KLIPS_PRINT(debug_pfkey," REMOVEFLOW SRCFLOW %08X %08X --> DSTFLOW %08X %08X\n",
 ...
 * Revision 1.9  2005/12/07 11:31:43  rupert
 * *: merge openswan 2.4.5dr3
 *
