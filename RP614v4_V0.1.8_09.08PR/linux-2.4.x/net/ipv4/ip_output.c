 ...
 *
 * Version:	$Id: ip_output.c,v 1.7 2005/05/11 07:06:33 tony Exp $
 *
...
#define IPPROTO_TCP 6
	...
	if((!sk->route_caps&NETIF_F_NO_CSUM) || (iph->protocol!=IPPROTO_TCP) || (iph->saddr==iph->daddr)|| (iph->daddr==0x7f000001))
#endif		
		ip_send_check(iph);
...
#ifdef CONFIG_RTL865XB_SW_LSO
//		rt->u.dst.pmtu	= CONFIG_RTL865XB_PS_MSS; //for UDP case
#endif
